                        ...
                        <table id="subjectsDataTable" class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $student->name }}</td>
                                    <td>{{ $student->guardian->father_name }} /{{ $student->guardian->mother_name }}
                                    </td>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            const deleteUrl = `{{ url('students') }}/${studentId}`; // Adjust the URL if needed

            console.log("Delete button clicked, ID:", studentId); // Debugging
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            console.log("Student deleted successfully:", response); // Debugging
                            Swal.fire(
                                'Deleted!',
                        ...
                        error: function(xhr) {
                            console.error("Error deleting student:", xhr); // Debugging
                            Swal.fire(
                                'Error!',
