...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="mb-4 text-center">Create New Guardian</h1>

            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('guardians.store') }}" method="POST" id="guardianForm">
                        @csrf
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <button type="submit" id="submitBtn" class="btn btn-success" style="display: none;">Create
                                Guardian</button>
                        </div>
                    </form>
                </div>
