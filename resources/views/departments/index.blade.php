...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="display-4 text-primary">Departments</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-danger delete-btn"
                                                data-id="{{ $department->id }}" title="Delete">
...
<script>
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        const deleteUrl = `{{ url('departments') }}/${departmentId}`; // Ensure this URL is correctly generated
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        console.error("Error deleting department:", xhr); // Debugging
                        Swal.fire(
                            'Error!',
